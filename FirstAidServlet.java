...
public class FirstAidServlet extends HttpServlet {
    ...
    private String buildResponse(String search, String category) {
    ...
    private boolean matchesCategory(String item, String category) {
    ...
    private boolean matchesSearch(String item, String search) {
        if (search.isEmpty()) {
            return true;
        }
